...
import { ExtendedColumnFilter, ExtendedColumnSort } from "@/lib/data-table/data-table.v3"
...
const filterItemSchema = z.object({
  ...
  variant: z.enum(dataTableFilterV3Config.filterVariants),
  operator: z.enum(dataTableFilterV3Config.operators),
  filterId: z.string(),
})
